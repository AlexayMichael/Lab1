...
class Variable implements Expression {
	...
	/**
	 * @return a string containing the name of the variable represented by the
	 *         Variable object
	 */
	 ...
	 * @param other
	 *            any Object
	 * @return true if other is an instance of Variable and if the name of the
	 *         variable it represents is the same as the name of variable
